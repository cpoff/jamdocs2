...
- Sheila will deliver approved documents, which should be attached to the meeting in Outlook. Documents will require [specific naming convention](#document-naming-convention). (See below)
